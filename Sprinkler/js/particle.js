...
class Particle extends THREE.Mesh {
     ...
     */
    update(gravity, drag, dT, base_height){
        ...
        var drag_accel = Math.sign(this.v.y) * -drag * this.v.y;
        this.r.y = this.r.y + (this.v.y * dT) + (0.5 * (drag_accel - gravity) * Math.pow(dT, 2));
        this.v.y = this.v.y + (drag_accel - gravity) * dT;
